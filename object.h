...
//            bitangent = glm::normalize(bitangent);
            ...
            std::cout << "VTX " << i/3 << " deltaPos1 " << glm::to_string(deltaPos1) << " deltaPos2 " << glm::to_string(deltaPos2) << " deltaUV1 " << glm::to_string(deltaUV1) << " deltaUV2 " << glm::to_string(deltaUV2) << " r " << r << "\n";
